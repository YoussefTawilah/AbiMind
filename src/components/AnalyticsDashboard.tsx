        ...
        {byDeck.length > 0 ? (
          <ul className="mt-5 space-y-2">
            {byDeck.map((row) => (
              <li
                key={row.deckId}
                className="flex items-center justify-between rounded-lg border border-border-subtle bg-surface-overlay px-3 py-2.5 text-sm"
              >
                <span className="font-medium text-text-primary">{row.deckName}</span>
